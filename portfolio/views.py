...
def portfolio(request, pk):
    ...
    #sum_initial_mutual = Mutual.objects.filter(customer=pk).aggregate(Sum('initial_value'))
    #sum_current_mutual = Mutual.objects.filter(customer=pk).aggregate(Sum('current_value'))
